...
import { IconBrandAws, IconBraces, IconDevices, IconAsset, IconTerminal2, IconCompass, IconBrandDocker, IconBrandNextjs, IconBrandUbuntu } from '@tabler/icons-react';
    ...
    <>
      <Modal opened={opened} onClose={close} title="RichDesigns.info" size="xl" centered>
        ...
        <Text>
            <Space h="md"></Space>
            <List>
                <ListItem icon={<IconCompass/>}>AWS VPC, Route53 routing table, registered domain; all routing/configuration</ListItem>
                ...
                <ListItem icon={<IconBrandDocker/>}>Docker containerisation of a web application</ListItem>
            </List>
        </Text>
        </ScrollArea.Autosize>         
      </Modal>
